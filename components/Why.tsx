  ...
  return (
    ...
    >
      <StaggerGroup className="grid grid-cols-1 gap-4 md:grid-cols-12">
        {/* Top-left wide — Generation, reframed as reassurance (indistinguishable
            from filmed UGC), kept in its original opening position. */}
        ...
        {/* Bottom row — Speed / Volume / Cost / Native, 4 across */}
