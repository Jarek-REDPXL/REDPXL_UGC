 ...
 * A compact soft cool-blue (mist) mini-canvas placed right after pricing: short
 * centered copy plus one green WhatsApp CTA. Reads smaller than the full
 * sections by design. Light mode.
 */
